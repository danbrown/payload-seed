...
const AfterDashboard: React.FC = () => {
  ...
  return (
    <div className={baseClass}>
      ...
      <p>
        This is a custom component that is rendered within the built-in
        dashboard component after its contents are rendered. Below, there are
        two cards that link to custom routes.
      </p>
